colony = 2
params.matrix = "/Users/gc3045/git/laml2-experiments/real_data/baseMemoir/inputs/baseMemoir_colony${colony}_kde_scores.csv"
...
Channel
    .fromPath("${params.tree_dir}/baseMemoir.colony${colony}.laml_best.nwk")
    .set { tree_files }
...
process run_fastlaml {
    ...
    publishDir "outputs_baseMemoir_colony${colony}", mode: 'copy'
