clone=3
params.matrix = "/Users/gc3045/git/laml2-experiments/real_data/PEtracer/inputs/colonies_clone${clone}_kde_scores_filtered.csv"
params.matrix_type = "observation-matrix"
params.fastlaml_bin = "/Users/gc3045/git/fast-laml/build/src/fastlaml"
params.seed = 0
params.max_iter = 10000 
params.tree_dir = "/Users/gc3045/git/laml2-experiments/real_data/PEtracer/runjobs/colonies_experiment2"
params.nw_topology = "nw_topology"   
params.python = "/Users/gc3045/miniconda3/bin/python3" 

Channel
    .fromPath("${params.tree_dir}/*exp2*.newick")
    .set { tree_files }
...
process make_topology {
    ...
    publishDir "colonies_experiment2_pt2", mode: 'copy'
