clone=2
params.matrix = "/Users/gc3045/git/laml2-experiments/real_data/PEtracer/inputs/petracer_clone${clone}_kde_scores.csv"
params.matrix_type = "observation-matrix"
params.fastlaml_bin = "/Users/gc3045/git/fast-laml/build/src/fastlaml"
params.seed = 0
params.max_iter = 5000
params.tree_dir = "/Users/gc3045/git/laml2-experiments/real_data/PEtracer/inputs/trees/seq_validation/"
...
process run_fastlaml {
    ...
    publishDir "outputs_petracer_seq_validation_clone${clone}", mode: 'copy'
