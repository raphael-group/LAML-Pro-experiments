...
params.tree_dir = "/Users/gc3045/git/laml2-experiments/real_data/PEtracer/inputs/trees/colonies/"

Channel
    .fromPath("${params.tree_dir}/clone${clone}_exp2*.nwk")
    .set { tree_files }
...
process run_fastlaml {
    ...
    publishDir "colonies_experiment2", mode: 'copy'
